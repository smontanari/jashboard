describe("jenkinsConfigurationHandler", function() {
  xit("should register a build type handler", function() {
    jenkins.plugin.build.buildConfigurationTypeAdapter = {
  ...
  it("should capture the build configuration for Jenkins", function() {
    var configuration = jashboard.plugin.build.jenkinsConfigurationHandler({type: 1, hostname: "test.host.name", port: 123, build_id: "test.build"});
