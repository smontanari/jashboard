Feature: Get dashboards
  ...
  Scenario: List all dashboards with monitors
    ...
    | monitor_1 | Zombie-Dash build | build | 0                | 0,0      | 240x140 | { type: "jenkins", hostname: "zombie-dev.host.com", port: 9080, build_id: "zombie_build" }                                        |
    | monitor_2 | Epic build        | build | 0                | 0,0      | 240x140 | { type: "go", hostname: "epic-ci.test.com", port: 81, pipeline: "epic main", stage: "epic build", job: "unit-integration tests" } |
    | monitor_3 | Random text       | ipsum | 0                | 0,260    | 280x150 | { no_sentences: 3, language: "english"}                                                                                           |
