Feature: List all dashboards
  ...
  Scenario: Dashboards with monitors
    ...
    And a dashboard with id "dashboard_1" and name "first dashboard" and monitors
    | monitor_1 |
    
    And a dashboard with id "dashboard_2" and name "second dashboard" and monitors
    | monitor_2 |
    | monitor_3 |

    And a dashboard with id "dashboard_3" and name "another dashboard" with no monitors

    When I request all the dashboard
