funcunitHelper.testFeature("Ajax loader display", "delayed_response", function() {
  test("should show ajax loaders until ajax response completes", function() {
    ...
    S("#monitor_2 .monitor-title .monitor-icon-ajax-loader").invisible(1000, null, "the ajax loader is hidden after 1 second");
    S("#monitor_1 .monitor-title .monitor-icon-ajax-loader").invisible(2000, null, "the ajax loader is hidden after 2 seconds");
  });
});