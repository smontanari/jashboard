jashboard.ModelMapper = function(pluginManager) {
  var that = this;
  this.mapMonitor = function(monitorData) {
    return _.tap(new jashboard.model.Monitor(monitorData), function(monitor) {
      ...
      monitor.configuration = monitorAdapter.parseConfiguration(monitorData.configuration);
    });
  };
  ...
  this.mapMonitorRuntimeInfo = function(monitorType, monitorRuntimeData) {
    ...
    return monitorAdapter.parseRuntimeInfo(monitorRuntimeData);
  };
